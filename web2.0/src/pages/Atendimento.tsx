import { ArrowDown, BookOpen, Contact, DoorClosed, FilterXIcon, Home, MessageSquareTextIcon, Search, User, Users } from "lucide-react";
...
import { ItemTicket, Ticket } from "../components/AtendimentoComponets/ItemTicket";
...
export const Atendimento = () => {
    ...
    const handleChange = async (event: { target: { name: any; checked: any; }; }) => {
    ...
    const statusTickets = useCallback(debounce((novoStatus: string) => {
                ...
                >
                    <Box>
                                    ...
                                    <div>
                                        ...
                                        >
                                            <div className="w-36 max-w-36">
                                                ...
                                                <ListItem className="hover:bg-zinc-200 cursor-pointer font-semibold"
                                                //  onClick={() => { handleClose(); abrirModalUsuario(); }}
                                                >
                                                    Perfil
                                                </ListItem>
                                                <Divider />
                            ...
                            >
                                <Tooltip title="Conversas em Privadas" arrow >
                                    <Tab
                                        ...
                                        icon={<User className={`w-6 h-6 ${grupoAtivo === 'enabled' ? 'text-red-400' : ''}   `} />}
                                        disableRipple
                                        className="relative"
                                        {...a11yProps(0, 'private')}
                                    />
                        ...
                        <div className="flex items-center justify-around">
                            <button id="filtro-avancado" onClick={handleClickMenu} aria-controls="simple-menu2">
                                <FilterXIcon size="18" />
                            </button>
                            <Menu
                                id="close-filtro"
                            ...
                            >
                                <span className="text-md flex justify-center">Filtros Avançados</span>
                                <MenuItem>
                                    {profile === "admin" && (
                                        <>
                                            <div className={`flex items-center ml-4 ${switchStates.showAll ? 'mb-4' : ''}`}>
                                                <Switch
                                                    name="showAll"
                                ...
                                {!pesquisaTickets.showAll && (
                                    <div>
                                        <Divider />
                                        <SelectComponent cUserQueues={[]} pesquisaTickets={pesquisaTickets} />
                                        <div className="my-4">
                            ...
                            <div className="flex gap-1 items-center px-1 p-2 rounded-xl border
                    ">
                                <Search size="18" />
                                <input type="search" name="searchParam" id=""
