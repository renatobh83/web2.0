...
export const ItemTicket: React.FC<Props> = ({
	...
	const ticketClass = classNames({
		...
		ticketNotAnswered:
			!ticket.answered && !ticket.isGroup && ticket.status === "open",
	});
			...
			<div className="pl-2 flex-1">
				...
				<div className="flex justify-between items-center mt-1">
					<div className="flex items-center space-x-1">
						<span
							className={`text-xs font-bold ${ticket.whatsapp ? "text-blue-600" : ""}`}
						>
				...
				<div className="text-xs text-gray-600">Usuário: {ticket.username}</div>
