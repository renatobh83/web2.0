...
export const useMixinSocket = () => {
    ...
    const { setTicketFocado, ticketFocado, updateMessages, updateTicket } = useAtendimentoTicketStore()
    const updateNotifications = useNotificationsStore(s => s.updateNotifications)
    const updateNotificationsP = useNotificationsStore(s => s.updateNotificationsP)
            ...
            socket.on('connect', () => {
                ...
                socket.on(`${usuario.tenantId}:ticketList`, async (data) => {
                    ...
                    if (data.type === "chat:create") {
                        if (!data.payload.read && (data.payload.ticket.userId === userId || !data.payload.ticket.userId)
